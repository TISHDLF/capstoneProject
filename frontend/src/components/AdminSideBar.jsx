...
const AdminSideBar = () => {
  ...
  //     try {
  //       const response = await axios.get(`http://localhost:5000/user/logged?user_id=${user.user_id}`, { withCredentials: true });
  ...
  return (
    <div className='relative flex flex-col w-auto h-screen bg-[#FFF] z-50 gap-2'>
      ...
      <div className='flex items-center justify-start gap-4  w-auto h-auto box-border pl-3 pr-12 pt-4 pb-4 cursor-pointer bg-white border-b-2 border-b-[#DC8801]' onClick={() => navigate('/dashboard')}>
        ...
        <div className='flex flex-col justify-center gap-1'>
          ...
          <div className={location.pathname === "/adopterslist" || location.pathname === "/adopterapplication" ? sideItemDownCurrent : sideItemStyle}>
            <div className='flex flex-row items-center justify-between w-full active:text-[#B5C04A]'>
              ...
              <button onClick={() => { toggleDropdown('adopters') }} className='flex justify-center items-center w-[30px] h-auto p-[8px] rounded-[25px] hover:bg-[#FDF5D8] active:bg-[#FFF]'>
