...
const CatProfile = () => {
    ...
    const [selectedImage, setSelectedImage] = useState('/src/assets/icons/CatImages/cat1.jpg');

    // Handler for image click
    const handleImageClick = (event) => {
        const imgSrc = event.target.src; // Get the clicked image source
        setSelectedImage(imgSrc); // Update state with new source
    };
                    ...
                    <div className='relative grid grid-cols-[60%_40%] w-[1000px] h-auto bg-[#FFF] p-5 rounded-[25px] shadow-md'>
                        ...
                        <div className='flex flex-col justify-between items-start p-5 w-full'>
                            ...
                            <div className='flex flex-col w-full gap-2'>
                                <Link to="/adopteeform" className='bg-[#B5C04A] text-[#FFF] font-bold p-3 rounded-[15px] w-full text-center hover:bg-[#CFDA34] active:bg-[#B5C04A]'>
