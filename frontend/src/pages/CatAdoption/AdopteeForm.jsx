            ...
            <form className='flex flex-col items-start p-10 gap-10'> 
                <div className='flex flex-row gap-2 w-full justify-between'>
                    ...
                    <div className='border-dashed border-2 border-[#B5C04A] rounded-[18px] p-2'>
                        <div className='w-[250px] h-auto rounded-[15px] overflow-hidden'>  
                            <img src="src/assets/icons/CatImages/cat1.jpg" alt="cat image" />
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='grid grid-cols-2 w-full gap-2'>
                        <label htmlFor="radioFBPage" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                            <input type="radio" id="radioFBPage" name="adaptionOpportunity" value="SPR Cats Facebook Page"/>
                        ...
                        <label htmlFor="radioFBGroup" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                            <input type="radio" id="radioFBGroup" name='adaptionOpportunity' value="Facebook Group"/>
                            Facebook Group
                        </label>
                        <label htmlFor="radioCommunityPage" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                            <input type="radio" id="radioCommunityPage" name="adaptionOpportunity" value="SPR Community Page"/>
                            SPR Community Page
                        </label>
                        <label htmlFor="referral" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                            <input type="radio" id="referral" name='adaptionOpportunity' value="Referred by a Volunteer"/>
                            Referred by a Volunteer
                        </label>
                        <label htmlFor="other" className='flex gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                            <input type="radio" name="adaptionOpportunity" id="other" className='bg-[#e6e6e6] rounded-[5px]'/>
                            Others
                        </label>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-row items-center gap-2'>
                        <div className='flex items-center justify-center w-[200px] h-full border-dashed border-2 border-[#898989] p-2 object-cover rounded-[15px]'>
                            <img src={imageSrc} alt="id-card" className='w-auto h-full'/>
                        </div>
                        <div className='flex flex-col w-auto'>
                            <label htmlFor="idUpload" className='bg-[#DC8801] p-2 rounded-[10px] text-[#FFF]'>
                                Attach ID Photo
                                <input type="file" accept="image/*" id='idUpload' hidden onChange={handleImageChange}/>
                            </label>
                ...
                <div className='flex flex-col gap-2'> 
                    ...
                    <label htmlFor="raisedYes" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="raisedCat" id="raisedYes" value="Yes, I know how to take care of a pet cat."/>
                    ...
                    <label htmlFor="raisedNo" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'> 
                        <input type="radio" name="raisedCat" id="raisedNo" value="No, this is my first time."/>
                ...
                <div className='flex flex-col gap-3'>
                    <div className='flex flex-col'>
                        <label>5. Do you have other pets right now? kindly provide informatio: </label>
                        <label className='italic text-[14px] text-[#7d7d7d]'>(Eg. "Yes, I have two dogs.")</label>
                    </div>

                    <input type="text" placeholder='Your answer here' className='flex items-center p-2 border-1 border-[#252525] rounded-[8px]'/>
                </div>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <label htmlFor="alone" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="currentSituation" id="alone" value="I live alone"/>
                        I live alone
                    </label>
                    <label htmlFor="family" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="currentSituation" id="family" value="I live with my family (no childred)."/>
                    ...
                    <label htmlFor="nochildren" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="currentSituation" id="nochildren" value="I live with my family (with one or more children)."/>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <label htmlFor="yesPickUp" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="pickup" id="yesPickUp" value="Yes, I'm able to do a pick-up."/>
                    ...
                    <label htmlFor="YesMeeting" className='flex items-center gap-2 p-2 border-1 border-[#252525] rounded-[8px]'>
                        <input type="radio" name="pickup" id="YesMeeting" value="Yes, we can arrange a halfway meeting."/>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <textarea name="" id="" rows="8" placeholder='You answer here' className='p-2 border-1 border-[#252525] rounded-[8px] resize-none'>
