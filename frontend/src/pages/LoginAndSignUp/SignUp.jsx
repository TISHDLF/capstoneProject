        ...
        <div className='grid grid-cols-[50%_50%] place-items-center h-screen overflow-hidden'> 
            ...
            <div className='flex flex-col gap-8 items-center bg-[#FFF] p-12 rounded-[25px] shadow-md'>
                ...
                <form onSubmit={HandleSignUp} className='grid grid-cols-2 gap-5'>
                    ...
                    <input type="text" placeholder='Contact Number' value={contactNumber} onChange={(e) => setContactNumber(e.target.value)} required className='border-b-2 border-b-[#A8784F] p-2' />
                    ...
                    <input type="password" placeholder='Password' value={password} onChange={(e) => setPassword(e.target.value)} required className='border-b-2 border-b-[#A8784F] p-2 grid-col' />
                    <input type="password" placeholder='Confirm Password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className='border-b-2 border-b-[#A8784F] p-2' />
