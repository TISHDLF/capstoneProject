...
const AboutUs = () => {
  return (
    <div className='flex flex-col pl-[12%] pt-6 h-screen'>
      <div className='relative flex flex-col items-center justify-center w-[1000px] h-auto p-10 bg-[#FFF] gap-5 rounded-[25px] shadow-md'>
