...
const CatProfileCreate = () => {
  ...
  const catCreate = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/cats/create", {
        name,
        age,
        gender,
        ...
        <div className="relative flex flex-col items-center p-10 min-h-screen gap-3 overflow-y-scroll">
          ...
          >
            ...
            <div className="flex flex-col w-full gap-2 p-5 rounded-[10px] border-1 border-[#a3a3a3] bg-[#FDF5D8]">
              <div className="flex w-full gap-2 justify-between border-b-1 border-b-[#595959] pb-2">
                <div className="flex gap-4 items-center">
                  <label className="text-[18px] text-[#2F2F2F] font-bold">
                    UPLOAD NEW IMAGE
                  </label>
                </div>
                <div className="flex items-center gap-1">
                  <button
                    className="p-2 pl-4 pr-4 w-auto h-auto bg-[#DC8801] text-[#FFF] rounded-[25px] cursor-pointer active:bg-[#2F2F2F]"
                    type="button"
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="p-2 pl-4 pr-4 bg-[#DC8801] text-[#FFF] font-bold w-auto rounded-[15px] hover:bg-[#FFB235] active:bg-[#DC8801]"
              >
                Save Changes
              </button>
            </div>
