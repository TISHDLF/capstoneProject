          ...
          <table className="flex flex-col gap-2 w-full">
            ...
            <tbody className="flex flex-col w-full gap-1 overflow-y-scroll min-h-[550px]">
              {filteredItems.map((user) => (
                <tr
                  key={user.user_id}
                  className="grid grid-cols-[10%_20%_30%_30%_20%] w-full place-items-center justify-items-start bg-[#FFF] text-[#2F2F2F] rounded-[10px] p-3 border-b-1 border-b-[#595959]"
                >
                  <td>{user.user_id}</td>
