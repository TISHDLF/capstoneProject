            ...
            <div className='relative flex flex-col items-center p-10 h-screen w-full gap-5 mx-auto'>
                ...
                <table className='flex flex-col w-full gap-2'>
                  <thead className='flex w-full'>
                    <tr className='grid grid-cols-[10%_20%_20%_20%_30%] justify-items-start place-items-start w-full bg-[#DC8801] p-3 rounded-[15px] text-[#FFF]'>
                      <th>Adoption ID</th>
                      <th>Name</th>
                  ...
                  <tbody className='flex flex-col w-full overflow-y-scroll max-h-[550px] gap-1'>
                    <tr className='grid grid-cols-[10%_20%_20%_20%_30%] w-full place-items-center justify-items-start bg-[#FFF] p-2 rounded-[15px] text-[#2F2F2F] border-b-1 border-b-[#595959]'>
                      <td>01</td>
                      ...
                      <td className='flex flex-row items-center justify-between gap-3 w-full'>
                        ...
                        <a href='/src/assets/UserProfile/(01 Laboratory Exercise 1 - ARG) Angelo Cabangal - Game Development.pdf' target='_blank' className='flex items-center justify-between self-start gap-3 p-2 pl-4 pr-4 bg-[#FDF5D8] text-[#2F2F2F] rounded-[10px] hover:underline border-dashed border-2 border-[#595959]'>
                          View Certificate
