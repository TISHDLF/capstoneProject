...
const NavigationBar = () => {
  return (
    <div className='fixed top-0 left-0 w-full grid grid-cols-[40%_40%_20%] bg-[#f9f7dc] box-content items-center max-h-[100px] border-b-2 border-b-[#DC8801] z-10'>
      <Link to="/" className='flex items-center justify-center w-auto h-[100px]'>
        <img className='max-w-full max-h-full object-contain p-[10px]'
        src={logo} alt="whiskerwatch logo" />
      </Link>
      <div className='flex flex-row justify-evenly items-center'>
        <Link to="/" className={pageStyling}>Home</Link>
