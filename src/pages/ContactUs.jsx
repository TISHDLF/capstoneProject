...
const ContactUs = () => {
  return (
    <div className='flex flex-row items-center pl-55 pb-12 w-auto h-screen'>
      <div className='relative flex flex-col items-center bg-[#FFF] w-[1000px] p-10 gap-10 rounded-[25px] shadow-md'>
        ...
        <div className='grid grid-cols-3 gap-5'>
          <div className='flex flex-col bg-[#FDF5D8] p-3 drop-shadow-[0px_-12px_0px_rgba(181,192,74,1)] rounded-[25px] gap-3'>
            ...
            <div className='flex flex-col'>
              <label>Free delivery with minimum purchase!</label>
          ...
          <div className='flex flex-col bg-[#FDF5D8] p-3 drop-shadow-[0px_-12px_0px_rgba(181,192,74,1)] rounded-[25px] gap-3'>
            ...
            <div className='flex flex-col'>
              ...
              <label>Dona Soledad, Paranaque City</label>
            </div>
            <div className='flex flex-col'>
              <label>Open 24 Hours for your pet's needs!</label>
              <label>
          ...
          <div className='flex flex-col bg-[#FDF5D8] p-3 drop-shadow-[0px_-12px_0px_rgba(181,192,74,1)] rounded-[25px] gap-3'>
            ...
            <div className='flex flex-row justify-between items-center'>
              <div className='flex flex-col'>
                <label className='font-bold'>Jeal's Petshop</label>
            ...
            <div className='flex flex-row justify-between items-center'>
              <div className='flex flex-col'>
                <label className='font-bold'>Grinsy Petshop</label>
                <label>Dona Soledad, Paranaque City</label>
              </div>
              <div>
