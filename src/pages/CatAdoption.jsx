...
const CatAdoption = () => {
  return (
    <div className='flex flex-col pt-8 pl-55 pb-20 h-screen w-auto'>
      <div className='grid grid-cols-3 w-[1000px] h-auto place-items-center gap-5'> 

        <div className='grid grid-rows-[60%_40%] bg-[#FFF] rounded-[25px] justify-center border-2 border-[#FFF] hover:shadow-lg active:border-2 active:border-[#DC8801]'>
