...
const AdminLogin = () => {
  return (
    <div className='flex flex-col items-center p-10 h-screen'>
        <div className='fixed flex flex-col items-center gap-10 w-100% min-w-[200px] h-auto bg-[#FFF] p-15 rounded-[25px] shadow-md'> 
            ...
            <div className='flex gap-2'>
                <button className='bg-[#DC8801] text-[#FFF] w-30 p-2 rounded-[25px] cursor-pointer active:bg-[#977655]'> Log In </button>
